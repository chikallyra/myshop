...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="index.html" class="logo">
      ...
      <span class="logo-lg"><b>MY</b>Shops</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="assets/dist/img/IMG_20191031_172018.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="assets/dist/img/IMG_20191031_172018.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Tri Putra Satriawan</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Tri Putra Satriawan - Web Developer
